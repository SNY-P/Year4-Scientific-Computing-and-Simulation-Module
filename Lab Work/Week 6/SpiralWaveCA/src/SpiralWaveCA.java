...
public class SpiralWaveCA {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // Define initial state - spiral wave at the bottom right corner.
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N; j++) {
                int dx = i - N + 10;
                int dy = j - N + 10;
                ...
                double phase = Math.sin(2 * Math.PI * r / 20.0 + angle);
                state[i][j] = phase > 0 ? 2 : 0;
            }
        }
        ...
        while (true) {
            ...
            // Calculate which cells have excited neighbours.
            for (int i = 0; i < N; i++) {
                for (int j = 0; j < N; j++) {
