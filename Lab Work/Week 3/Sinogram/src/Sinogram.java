...
public class Sinogram {
    ...
    static final double SCALE = 0.0045 ;  // think of a better way to parametrize this later...
    ...
    public static void main(String [] args) {
        // array of density oof value of the model for display purposes
        ...
        DisplaySinogramFT display3 = new DisplaySinogramFT(sinogramFTRe, sinogramFTIm, N,"Sinogram radial Fourier Transform") ;
        ...
        for(int iTheta = 0 ; iTheta < N ; iTheta++) {
            for(int iK = 0 ; iK < N ; iK++) {
                ...
                // ---- LOW PASS COSINE FILTER ---- // ---- |K| cos(πK/(2 CUTOFF)) ---- //
        ...
        DisplayDensity display7 = new DisplayDensity(sinogramFTRe2, N, "Filtered sinogram, Low Pass Cosine Filter") ;
        // ---- SINOGRAM FILTERING ENDS HERE ---- //
        ...
        DisplayDensity display8 = new DisplayDensity(backProjection2, N, "Back projected sinogram, Low Pass Cosine Filter",
                                                    GREY_SCALE_LO, GREY_SCALE_HI) ;
    }
